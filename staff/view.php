            ...
            <div class="card">
                ...
                <form class="row g-3 needs-validation" action="../php/signup.php" method="POST" novalidate>
                    ...
                    <div class="col-md-12 position-relative">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" name="name" required autofocus="autofocus" value="<?php echo $name; ?>" disabled>
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" name="username" required disabled value="<?php echo $username; ?>">
                        <div class="invalid-tooltip">
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <input type="email" class="form-control" id="validationTooltip01" name="email" required disabled value="<?php echo $email; ?>">
                        <div class="invalid-tooltip">
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <input type="text" class="form-control" id="validationTooltip01" name="phone_number" maxlength="11" required disabled value="<?php echo $phone_number; ?>">
                        <div class="invalid-tooltip">
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <div class="col-sm-12">
                            <select class="form-select" aria-label="Default select example" name="user_type" id="validationTooltip03" required disabled>
