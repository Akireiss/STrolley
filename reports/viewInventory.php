...
$sql = "SELECT p.*, i.address FROM products p
...
// Check if any inventory items are found
...
<main id="main" class="main">
    ...
    .edit-btn {
        ...
        color: #fff;
                    ...
                    <table id="example" class="table table-striped table-bordered table-hover">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col" class="total-column">Total Weight</th>
                                <th scope="col" class="total-column">Total Cost</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php while ($inventory = $result->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <!-- <td><?php echo $inventory["inventory_valuation_method"]; ?></td> -->
                                    <td><?php echo $inventory["unit_price"]; ?></td>
                                    <td><?php echo $inventory["quantity"]; ?></td>
                                    <td><?php echo $inventory["measurements"]; ?></td>
                                    <td class="total-column"><?php echo $inventory["weight"]; ?></td>
                                    <td class="total-column"><span>₱</span><?php echo $inventory["total_cost"]; ?></td>
                ...
                <div class="gray-background"></div> <!-- Add a gray background after the table -->
