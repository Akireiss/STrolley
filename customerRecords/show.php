...
<main id="main" class="main">
    <section class="section dashboard">
        <div class="row">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Show Customer Details</h5>
                </div>
                <form class="row g-3 needs-validation" action="" method="post" novalidate>
                    <!-- First Name Field -->
                    <div class="col-md-3 position-relative">
                        <label class="form-label">First Name<font color="red">*</font></label>
                        <input type="text" class="form-control" name="first_name" value="<?php echo htmlspecialchars($customer['first_name']); ?>" disabled required autofocus="autofocus">
                    ...
                    <div class="col-md-3 position-relative">
                        ...
                        <input type="text" class="form-control" value="<?php echo htmlspecialchars($customer['middle_name']); ?>" name="middle_name" disabled>
                    </div>

                    <!-- Last Name Field -->
                    <div class="col-md-3 position-relative">
                        <label class="form-label">Last Name<font color="red">*</font></label>
                        <input type="text" class="form-control" name="last_name" value="<?php echo htmlspecialchars($customer['last_name']); ?>" required disabled>
                        <div class="invalid-tooltip">
                    ...
                    <div class="col-md-3 position-relative">
                        ...
                        <input type="text" class="form-control" value="<?php echo htmlspecialchars($customer['suffix']); ?>" name="suffix" disabled>
                    </div>

                    <!-- Region Field -->
                    <div class="col-md-3 position-relative">
                        <label class="form-label">Region<font color="red">*</font></label>
                        <select class="form-select" aria-label="Default select example" name="region_id" id="region" required disabled>
                    ...
                    <div class="col-md-3 position-relative">
                        ...
                        <select class="form-select" aria-label="Default select example" name="province_id" id="province" required disabled>
                    ...
                    <div class="col-md-3 position-relative">
                        ...
                        <select class="form-select" aria-label="Default select example" name="municipality_id" id="city" required disabled>
    ...
    <select class="form-select" aria-label="Default select example" name="barangay_id" id="barangay" required disabled>
        ...
        ?>
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <div class="col-sm-12">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sex" id="sexMale" value="Male" disabled required <?php if ($customer['sex'] === 'Male') echo 'checked'; ?>>
                                <label class="form-check-label" for="sexMale">
                                    Male
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="sex" id="sexFemale" disabled value="Female" <?php if ($customer['sex'] === 'Female') echo 'checked'; ?>>
                    ...
                    <div class="col-md-6 position-relative">
                        ...
                        <div class="col-sm-12">
                            <select class="form-select" aria-label="Default select example" name="civil_status" id="civil_status" required disabled>
                    ...
                    <div class="col-12">
                        ...
                        <a href="tbl_customers.php" class="btn btn-primary mb-3">Back</a>
                    </div>
                </form>
            </div>
        </div>
